...
return win;
},prompt:function(_29c,msg,fn,defV){
...
win.children("input.messager-input").focus();                   //更改让弹出框可自动聚焦
if(defV!=undefined)win.find("input.messager-input").val(defV);  //更改使之有默认值
return win;
